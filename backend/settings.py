...
ALLOWED_HOSTS = ['top-three.herokuapp.com']
...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['http://localhost:8000', 'https://top-three.herokuapp.com', ],
    'SERIALIZERS': {
...
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = env('GOOGLE_OAUTH_SECRET_KEY')
